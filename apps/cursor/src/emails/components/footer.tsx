  ...
  return (
    <Section>
      ...
      <Text className="text-xs leading-6 mb-4 text-left font-mono">
        Bounty Directory - the home for everything Cursor
      </Text>
      ...
      <Section className="mt-8 flex gap-3">
        <Text className="text-xs leading-6 mb-4 text-left font-mono text-[#B8B8B8]">
          © {new Date().getFullYear()} Bounty Directory. All rights reserved.
          This email was sent to you because you signed up for Bounty Directory.
        </Text>
      </Section>
    </Section>
  );
